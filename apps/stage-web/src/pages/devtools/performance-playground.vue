...
import type { EmotionPayload } from '@proj-sakura/stage-ui/constants/emotions'
...
import { useDelayMessageQueue, useEmotionsMessageQueue } from '@proj-sakura/stage-ui/composables/queues'
import { llmInferenceEndToken } from '@proj-sakura/stage-ui/constants'
import { EMOTION_EmotionMotionName_value, EMOTION_VRMExpressionName_value, EmotionThinkMotionName } from '@proj-sakura/stage-ui/constants/emotions'
import { useAudioContext, useSpeakingStore } from '@proj-sakura/stage-ui/stores/audio'
