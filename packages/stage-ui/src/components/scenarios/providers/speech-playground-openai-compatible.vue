...
import { FieldCheckbox, FieldInput } from '@proj-sakura/ui'
  ...
  <div w-full rounded-xl>
    ...
    <div flex="~ col gap-4">
      ...
      <button
        ...
        :disabled="isGenerating || (!testText.trim() && !useSSML) || (useSSML && !ssmlText.trim()) || (!apiKeyConfigured && !disableApiKeyInput)"
        :class="{ 'opacity-50 cursor-not-allowed': isGenerating || (!testText.trim() && !useSSML) || (useSSML && !ssmlText.trim()) || (!apiKeyConfigured && !disableApiKeyInput) }"
