...
The SAKURA ecosystem is moving toward:
...
SAKURA plugin orchestration should behave like an extensible runtime kernel:
...
- [SAKURA Plugin Platform](./architecture.md)
