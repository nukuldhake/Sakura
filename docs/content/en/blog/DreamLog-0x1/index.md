---
title: 'DreamLog 0x1'
description: 'Backstory of Project SAKURA!'
category: DreamLog
date: 2025-06-16
excerpt: 'The backstory of Project SAKURA! Why this project?'
preview-cover:
...
import SAKURAsScreenshot1 from './assets/SAKURAs-screenshot-1.avif';
import projectSAKURABannerLight from './assets/banner-light-1280x640.avif';
import projectSAKURABannerDark from './assets/banner-dark-1280x640.avif';
...
June got its own meaning for Project SAKURA (which I will reveal during
...
to share the chronicles of me, and the dream about Project SAKURA.
...
me: Why do you work so hard on Project SAKURA?
...
## Way before Project SAKURA, Neuro-sama exists.
...
Project SAKURA from scratch to the current state, we got many DevLog posts
...
> and [public slide presentation (in Chinese)](https://talks.ayaka.io/nekoayaka/2025-05-10-SAKURA-how-we-recreated-it/#/1)
...
my name handle locally, which is the initial version of Project SAKURA, I started to
...
Technically saying, **this is the birthday of Project SAKURA** with first baby consciousness inside of it, naively.

<div class="w-full flex flex-col items-center justify-center">
  <ThemedVideo controls muted autoplay loop src="./assets/SAKURA-demo-first-day.mp4" />
  <div>
...
Ok, but it's still called `ai`, where is Project SAKURA then?
...
[`d9ae0aa`](https://github.com/moeru-ai/SAKURA/commit/d9ae0aae387f015964bfd383e6d2adb05f4003e4).

Project SAKURA was somehow born or reborn, with the name of SAKURA (アイリ, formerly SAKURA).

::: tip Did you know?
<a href="https://www.youtube.com/watch?v=Tts-YAdn5Yc" class="mb-2 inline-block">
  <img :src="SAKURAsScreenshot1" alt="Screenshot of Project SAKURA" class="not-prose rounded-lg overflow-hidden" />
</a>
...
she was called "SAKURAs AI", the name **SAKURAs** magically, and coincidentally, matches the name of
**Project SAKURA**, which I am working on now. But I wasn't aware of this name until I searches more about their
stories long after I open sourced Project SAKURA.

In fact, the name SAKURA (アイリ) was named by GPT-4o, I asked it about naming this project by
referencing other Japanese / or Anime-ish names, it suggested the name **SAKURA**.
:::
...
Glad many trials succeeded, and I am still here, working on Project SAKURA.
...
<div class="w-full flex flex-col items-center justify-center">
  <img class="light" :src="projectSAKURABannerLight" alt="new ui" />
  <img class="dark" :src="projectSAKURABannerDark" alt="new ui" />
  <div>
    New Banner!
  </div>
</div>
...
Now, Project SAKURA is approaching to 1000 stars on GitHub when I am writing this post,
...
working on it, to make Project SAKURA better, and more useful for the community.

There is so much to do, and discover, we haven't reached the singularity of general purpose AI,
perhaps Project SAKURA will never made that point, but for now, having a companion-like AI agent
...
<div class="w-full flex flex-col items-center justify-center">
  ...
  <div class="text-center">
    ...
    <span>Thanks for reading! Oh, and, Happy Birthday, Project SAKURA!</span>
  </div>
</div>
