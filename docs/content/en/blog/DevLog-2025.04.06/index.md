...
[`telegram-bot`](https://github.com/moeru-ai/SAKURA/tree/main/services/telegram-bot),
for the upcoming memory update for Project SAKURA. Which we were planning to implement
for months.
...
We also added Character Card support to Project SAKURA. Character Cards are JSON files that define
...
We've been working on improving the visual theme of Project SAKURA. The new theme system now supports:
...
We're excited to see the community starting to contribute to Project SAKURA! Some notable contributions include:
...
[contributing guidelines](https://github.com/moeru-ai/SAKURA/blob/main/CONTRIBUTING.md).
...
We're also planning to release more detailed documentation about each component of Project SAKURA,
including architecture deep dives and implementation guides.

## Conclusion

It's been an exciting period of development for Project SAKURA. The memory system is taking shape,
