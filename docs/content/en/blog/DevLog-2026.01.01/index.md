...
date: 2026-01-01
excerpt: |
  Sharing SAKURA's progress on the iOS platform, the problems we encountered and their solutions, as well as some achievements and implementation details of the memory layer experiments in FlowChat by LemonNeko.
preview-cover:
...
Happy New Year! This is [@LemonNekoGH](https://github.com/LemonNekoGH), one of SAKURA's maintainers. The first DevLog of the new year is mine, (pressing B key to select laughing emoji) hahahahaha!
...
Two days ago, we introduced [Capacitor](https://capacitorjs.com/) to build mobile applications for SAKURA ([#845](https://github.com/moeru-ai/SAKURA/pull/845)), which we call SAKURA Pocket.
...
<p style="display: flex; justify-content: center;">
    <video src="./assets/SAKURA-notification-capability.mp4" alt="SAKURA Pocket Notification" controls width="230" height="500"></video>
</p>

Don't worry too much about that default Capacitor icon—we'll replace it later.

In the video, I removed SAKURA from the background app list, and shortly after, SAKURA popped up a notification. This kind of background notification is hard to achieve in PWAs, but it's a breeze on native iOS apps.
