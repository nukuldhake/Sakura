...
fundamental animations and transitions for SAKURA.
...
> "proj-SAKURA" + "${subDirectory}" + "$｛packageName}" pattern for the Netlify
> deployment.
...
I deployed the official documentation site onto [https://SAKURA.build](https://SAKURA.build) yesterday,
[@kwaa](https://github.com/kwaa) commented that he would suggest me try
the `https://SAKURA.more.ai/docs` approach instead, ~~but I couldn't figure out~~
...
capable of porting for SAKURA to use, good news is,
...
animation component into SAKURA's website main stage, it wasn't that smooth,
...
already at our official deployment at [https://SAKURA.moeru.ai](https://SAKURA.moeru.ai).
