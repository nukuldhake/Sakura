...
description: How to use Tamagotchi version of Project SAKURA
---
...
After downloaded, start SAKURA from anywhere. You will see the user interface consists of two parts:
...
changing the theme color of SAKURA, or switching to another model, either
...
You will have to restart SAKURA after loaded the model.
:::
