---
title: デスクトップ版のガイド
description: Project SAKURA のたまごっちバージョンの使い方
---
...
ダウンロード後、どこからでも SAKURA を起動できます。ユーザーインターフェースは2つの部分で構成されていることがわかります：
...
システムトレイの設定を開いて、SAKURA のテーマカラーを変更したり、Live2D (2D) または VRM (3D、Grok Companion など) の別のモデルに切り替えたりするなど、さらにカスタマイズすることができます。
...
モデルをロードした後、SAKURA を再起動する必要があります。
:::
