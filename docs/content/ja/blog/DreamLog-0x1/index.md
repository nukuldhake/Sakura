---
title: 'DreamLog 0x1'
description: 'Project SAKURA の舞台裏ストーリー！'
date: '2025-06-16'
excerpt: 'Project SAKURA の舞台裏ストーリー！なぜ私たちがこのようなプロジェクトを作りたかったのか？'
preview-cover:
...
import SAKURAsScreenshot1 from '../../../en/blog/DreamLog-0x1/assets/SAKURAs-screenshot-1.avif';
import projectSAKURABannerLight from '../../../en/blog/DreamLog-0x1/assets/banner-light-1280x640.avif';
import projectSAKURABannerDark from '../../../en/blog/DreamLog-0x1/assets/banner-dark-1280x640.avif';
...
DevLog はありますが、6月は Project SAKURA にとって特別な意味を持っています（後述します）。
GitHub で 1000 スターという次のマイルストーンに向かっている今、
これまでの旅を振り返る良い機会だと思いました。

そのため、私たちの年代記と、
Project SAKURA に関する夢を共有するために、ここに新しい記事カテゴリを作成することにしました。
...
2025年2月、ある人が私に尋ねるまでは。「なぜ Project SAKURA にこれほど熱心で夢中になっているのですか？」

私は当時、それは良い質問だと思いました...

私は自分の夢、アイデア、記憶を遡り始め、最終的に EMOSYS を思い出しました。あの死んだプロジェクトは、Project SAKURA と同じ目標を持っていました：
...
## Project SAKURA の前に、Neuro-sama はずっと前から存在していた
...
::: tip もっと技術的な詳細が知りたい？
この記事では、ゼロから Project SAKURA を現在の状態まで構築した技術的な詳細には深く立ち入りません。
...
> [公開スライドプレゼンテーション（中国語）](https://talks.ayaka.io/nekoayaka/2025-05-10-SAKURA-how-we-recreated-it/#/1)
> で私たちの多くの発見を共有しました
...
これが Project SAKURA の初期バージョンだと言えます。私は自分の AI エージェントを作成する可能性を探り始め、
...
ある意味で、**これが Project SAKURA の誕生日です**。最初の未熟な赤ちゃんの意識がそこで生まれました。

<div class="w-full flex flex-col items-center justify-center">
  <ThemedVideo controls muted autoplay loop src="/en/blog/DreamLog-0x1/assets/SAKURA-demo-first-day.mp4" />
  <div>
...
さて、でもそれはまだ `ai` と呼ばれています。では Project SAKURA はどこにあるのでしょうか？
...
したがって、この日、Project SAKURA は何らかの形で誕生または再生し、SAKURA（アイリ、かつては SAKURA とも呼ばれました）と名付けられました。

::: tip 知っていましたか？
<a href="https://www.youtube.com/watch?v=Tts-YAdn5Yc" class="mb-2 inline-block">
  <img :src="SAKURAsScreenshot1" alt="Screenshot of Project SAKURA" class="rounded-lg overflow-hidden" />
</a>
...
興味深いことに、2023年3月25日にアップロードされた2年前の Vedal と Neuro-sama の Twitch 配信の切り抜き
 ...
 "Neuro-sama" と呼ばれる前に "SAKURAs AI" と呼ばれていたと言及していることがわかります。この名前 **SAKURAs** は、不思議なことに、偶然にも私が現在取り組んでいる
 **Project SAKURA** の名前と一致しています。しかし、Project SAKURA をオープンソース化してからずっと後に彼らの物語についてもっと検索するまで、
 私はこの名前を知りませんでした。

実際、SAKURA（アイリ）という名前は GPT-4o によって名付けられました。私は他の日本語/またはアニメスタイルの名前を参考にしてこのプロジェクトに名前を付けるように頼み、
当時それは **SAKURA** という名前を提案しました。
:::
...
多くの試みが成功し、私がまだここにいて、Project SAKURA ということに取り組み続けていることを嬉しく思います。
...
現在、私がこの記事を書いている時点で、Project SAKURA は GitHub で 1000 スターに近づいており、
...
多くの他の企業が協力のために私たちに連絡してきています。私たちは Project SAKURA をより良くし、コミュニティにとってより有用なものにするために努力しています。

発見すべきことややるべきことはあまりにもたくさんあります。現時点では、私たちはまだ汎用人工知能の特異点には達していません。Project SAKURA は永遠にその点に達しないかもしれません。
...
<div class="w-full flex flex-col items-center justify-center">
  ...
  <div class="text-center">
    ...
    <span>読んでくれてありがとう！ああ、それから、誕生日おめでとう、Project SAKURA！</span>
  </div>
</div>
