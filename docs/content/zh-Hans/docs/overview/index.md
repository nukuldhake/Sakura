---
title: 这是什么项目？
description: 了解 Project SAKURA 的用户界面
---
...
客户端则更适合进行高级操作，例如 VTuber 直播、computer-use 以及访问本地 LLM 模型，此时无需为运行 SAKURA 支付大量 token 费用。
...
有关如何设计和改进 Project SAKURA 用户界面的参考资料，请参阅 [设计指南](../overview/contributing/design-guidelines/resources) 页面。
