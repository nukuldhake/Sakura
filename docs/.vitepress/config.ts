...
export default defineConfig({
  ...
  head: [
    ...
    ['script', { async: '', src: 'https://moeru-ai-SAKURA-helper.kwaa.workers.dev/remote-assets/page-external-data/js/script.js' }],
    ['script', {}, `
      window.plausible=window.plausible||function(){(plausible.q=plausible.q||[]).push(arguments)},plausible.init=plausible.init||function(i){plausible.o=i||{}};
      plausible.init({
        endpoint: "https://moeru-ai-SAKURA-helper.kwaa.workers.dev/api/v1/page-external-data/submit"
      })
    `],
    ['script', {}, `
      ;(function () {
  ...
  locales: {
    'root': {
      ...
      themeConfig: {
        ...
        editLink: {
          pattern: 'https://github.com/moeru-ai/SAKURA/edit/main/docs/content/:path',
  ...
  vite: {
    resolve: {
      alias: {
        '@proj-sakura/stage-ui/components': resolve(join(import.meta.dirname, '..', '..', 'packages', 'stage-ui', 'src', 'components')),
